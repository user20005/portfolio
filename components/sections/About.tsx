          ...
          <div className="md:col-span-4">
            <div className="sticky top-24">
              ...
              <p className="text-gray-400 text-base leading-relaxed">
                De la création web à l'ingénierie des systèmes embarqués.
              </p>
            </div>
          </div>
            ...
            <div className="space-y-6">
              ...
              <div className="story-card relative">
                ...
                <div className="bg-white/5 border border-white/10 p-5 rounded-xl hover:bg-white/10 transition-colors backdrop-blur-sm">
                  <div className="text-cyan-400 font-mono text-xs mb-1 tracking-widest">
                    CHAPITRE 1
                  </div>
                  <h3 className="text-xl text-white font-bold mb-2">
                    Les Débuts & Le Freelance
                  </h3>
                  <p className="text-gray-300 text-sm leading-relaxed">
                    Tout a débuté au lycée <strong className="text-cyan-400">Le Corbusier</strong>. Je me
                    suis lancé en freelance, créant des sites web, des
                    interfaces logicielles en parallèle de mes études.
                  </p>
                </div>
              </div>
              ...
              <div className="story-card relative">
                ...
                <div className="bg-white/5 border border-white/10 p-5 rounded-xl hover:bg-white/10 transition-colors backdrop-blur-sm">
                  <div className="text-blue-400 font-mono text-xs mb-1 tracking-widest">
                    CHAPITRE 2
                  </div>
                  <h3 className="text-xl text-white font-bold mb-2">
                  ...
                  <p className="text-gray-300 text-sm leading-relaxed">
                    Coder des interfaces logicielles me plaisait, mais je
                    voulais me rapprocher{" "}
                    <span className="text-amber-400 font-medium">
                      {" "}
                      du matériel
                    </span>
                    . Je voulais comprendre l'origine des données,comment le
                    code interagit directement avec les composants électroniques
                    pas juste les afficher.
                  </p>
                </div>
              </div>
              ...
              <div className="story-card relative">
                ...
                <div className="bg-gradient-to-br from-purple-900/20 to-blue-900/20 border border-purple-500/30 p-5 rounded-xl hover:border-purple-500/50 transition-colors backdrop-blur-sm">
                  <div className="text-purple-400 font-mono text-xs mb-1 tracking-widest">
                    AUJOURD'HUI
                  </div>
                  <h3 className="text-xl text-white font-bold mb-2">
                    L'ingénierie en Systèmes Embarqués
                  </h3>
                  <p className="text-gray-300 text-sm leading-relaxed">
                    Mon but : concevoir la carte électronique, souder les
                    composants <em>ET</em> programmer. Je veux maîtriser
                    l'ensemble du processus, de la conception à la réalisation,
                    pour créer des projets complets et fonctionnels.
                  </p>
                </div>
              </div>
            </div>
...
const FocusCard = ({ title, desc, icon, color, bgColor }: any) => (
  <div className="group relative bg-[#111] border border-white/10 p-4 rounded-xl hover:-translate-y-1 transition-all duration-300">
    <div
      className={`absolute inset-0 ${bgColor} opacity-0 group-hover:opacity-10 rounded-xl transition-opacity`}></div>

    <div className="flex items-center gap-3 mb-2">
      <div
        className={`w-8 h-8 ${bgColor} ${color} rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform`}>
        <svg
          className="w-4 h-4"
          fill="none"
          stroke="currentColor"
      ...
      <h3 className="text-base text-white font-bold group-hover:text-white transition-colors">
        {title}
      </h3>
    </div>
